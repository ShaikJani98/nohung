...
<script>
    var defaultimage = '<?= FRONT_URL . 'assets/images/upload-icon.svg' ?>';
</script>
<div class="offerManagementWrap">
    <div class="offermanageTopHeading">
        <h2>Add Master Menu</h2>
                            ...
                            <div class="tab-pane active" id="SouthIndianBreakfast" role="tabpanel">
                                <div class="southIndiaBreakFastContent">
                                    <div class="vegAndNon_veg">
                                        ...
                                        <span><img src="<?= FRONT_URL ?>assets/images/vegan.svg" alt="">Veg</span>
                                    </div>
                                                ...
                                                <?php if (!empty($si_breakfast)) {
                                                    ...
                                                    for ($i = 0; $i < $vegbflength; $i++) {
                                                        ...
                                                        if (!empty($si_breakfast['veg']) && isset($si_breakfast['veg'][$i])) {
                                                            ...
                                                            $imagesrc = FRONT_URL . 'assets/images/upload-icon.svg';
                                                        ...
                                                        <tr class="si_bf_veg" id="si_bf_veg<?= $id ?>">
                                                            ...
                                                            <td>
                                                                <div class="form-group" id="el_itemname_si_bf_veg<?= $id ?>" style="margin-bottom: 0;">
                                                                    <input type="text" class="menu-input" name="itemname_si_bf_veg[]" id="itemname_si_bf_veg<?= $id ?>" value="<?= $itemname ?>" data-provide="itemname_si_bf_veg<?= $id ?>" placeholder="Enter Item Name">
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-group" id="el_itemprice_si_bf_veg<?= $id ?>" style="margin-bottom: 0;">
                                                                    <input type="text" class="menu-input s-input" name="itemprice_si_bf_veg[]" id="itemprice_si_bf_veg<?= $id ?>" value="<?= $itemprice ?>" placeholder="Price">
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-group" id="el_itemqty_si_bf_veg<?= $id ?>" style="margin-bottom: 0;">
                                                                    <input type="text" class="menu-input s-input" name="itemqty_si_bf_veg[]" id="itemqty_si_bf_veg<?= $id ?>" value="<?= $itemdetail ?>" placeholder="Quantity">
                                                                </div>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td class="text-center">
                                                                <a href="javascript:void(0)" class="add-menu-row addbtn_si_bf_veg" onclick="additem('si_bf_veg')" style="<?php if ($id != $vegbflength) {
                                                                                                                                                                                echo 'display:none;';
                                                                                                                                                                            } ?>""><img src=" <?= FRONT_URL ?>assets/images/menu-plus.svg" alt=""></a>
                                                                <a href="javascript:void(0)" class="rmbtn_si_bf_veg" onclick="removeitem('si_bf_veg<?= $id ?>')" style="<?php if ($id == $vegbflength) {
                                                                                                                                                                            echo 'display:none;';
                                                                                                                                                                        } ?>"><img src="<?= FRONT_URL ?>assets/images/trash.svg" alt=""></a>
                                                            </td>
                                                            <script>
                                    ...
                                    <div class="vegAndNon_veg" id="nonveg_si_section">
                                        <h1 style="visibility: hidden;">Hello</h1>
                                        <span><img src="<?= FRONT_URL ?>assets/images/Non_chicken.svg" alt="">Non-Veg</span>
                                    </div>
                                            ...
                                            <table class="table">
                                                ...
                                                ?>
                                                        ...
                                                        <tr class="si_bf_nonveg" id="si_bf_nonveg<?= $id ?>">
                                                            ...
                                                            <td class="text-center">
                                                                <a href="javascript:void(0)" class="add-menu-row addbtn_si_bf_nonveg" onclick="additem('si_bf_nonveg')" style="<?php if ($id != $nonvegbflength) {
                                                                                                                                                                                    echo 'display:none;';
                                                                                                                                                                                } ?>""><img src=" <?= FRONT_URL ?>assets/images/menu-plus.svg" alt=""></a>
                                                                <a href="javascript:void(0)" class="rmbtn_si_bf_nonveg" onclick="removeitem('si_bf_nonveg<?= $id ?>')" style="<?php if ($id == $nonvegbflength) {
                                                                                                                                                                                    echo 'display:none;';
                                                                                                                                                                                } ?>"><img src="<?= FRONT_URL ?>assets/images/trash.svg" alt=""></a>
                                                            </td>
                                                            <script>
                                        ...
                                        <form action="#" id="si_lunch_form" class="form-horizontal" enctype="multipart/form-data">
                                            ...
                                            <div class="vegAndNon_veg">
                                                ...
                                                <span class="food-type">
                                                    <span class="veg">
                                                        <img src="<?= FRONT_URL ?>assets/images/vegan.svg" alt="">Veg
                                                    </span>
                                                    <span class="nonveg">
                                                        <img src="<?= FRONT_URL ?>assets/images/Non_chicken.svg" alt=""> Non Veg
                                                    </span>
                                                </span>
                                            </div>
                                            <div class="tab-content">
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <tr class="si_lunch_<?= $cat ?>" id="si_lunch_<?= $cat . $id ?>">
                                                                        ...
                                                                        <td class="text-center">
                                                                            <a href="javascript:void(0)" class="add-menu-row addbtn_si_lunch_<?= $cat ?>" onclick="additem('si_lunch_<?= $cat ?>','lunch_dinner')" style="<?php if ($id != $lunchlength) {
                                                                                                                                                                                                                                echo 'display:none;';
                                                                                                                                                                                                                            } ?>""><img src=" <?= FRONT_URL ?>assets/images/menu-plus.svg" alt=""></a>
                                                                            <a href="javascript:void(0)" class="rmbtn_si_lunch_<?= $cat ?>" onclick="removeitem('si_lunch_<?= $cat . $id ?>')" style="<?php if ($id == $lunchlength) {
                                                                                                                                                                                                            echo 'display:none;';
                                                                                                                                                                                                        } ?>"><img src="<?= FRONT_URL ?>assets/images/trash.svg" alt=""></a>
                                                                        </td>
                                                                        <script>
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            ?>
                                                                ...
                                                                <tr class="si_dinner_<?= $cat ?>" id="si_dinner_<?= $cat . $id ?>">
                                                                    ...
                                                                    <td class="text-center">
                                                                        <a href="javascript:void(0)" class="add-menu-row addbtn_si_dinner_<?= $cat ?>" onclick="additem('si_dinner_<?= $cat ?>')" style="<?php if ($id != $dinnerlength) {
                                                                                                                                                                                                            echo 'display:none;';
                                                                                                                                                                                                        } ?>""><img src=" <?= FRONT_URL ?>assets/images/menu-plus.svg" alt=""></a>
                                                                        <a href="javascript:void(0)" class="rmbtn_si_dinner_<?= $cat ?>" onclick="removeitem('si_dinner_<?= $cat . $id ?>')" style="<?php if ($id == $dinnerlength) {
                                                                                                                                                                                                    echo 'display:none;';
                                                                                                                                                                                                } ?>"><img src="<?= FRONT_URL ?>assets/images/trash.svg" alt=""></a>
                                                                    </td>
                                                                    <script>
                                            ...
                                            <table class="table">
                                                ...
                                                ?>
                                                        ...
                                                        <tr class="ni_bf_veg" id="ni_bf_veg<?= $id ?>">
                                                            ...
                                                            <td class="text-center">
                                                                <a href="javascript:void(0)" class="add-menu-row addbtn_ni_bf_veg" onclick="additem('ni_bf_veg')" style="<?php if ($id != $vegbflength) {
                                                                                                                                                                                echo 'display:none;';
                                                                                                                                                                            } ?>""><img src=" <?= FRONT_URL ?>assets/images/menu-plus.svg" alt=""></a>
                                                                <a href="javascript:void(0)" class="rmbtn_ni_bf_veg" onclick="removeitem('ni_bf_veg<?= $id ?>')" style="<?php if ($id == $vegbflength) {
                                                                                                                                                                            echo 'display:none;';
                                                                                                                                                                        } ?>"><img src="<?= FRONT_URL ?>assets/images/trash.svg" alt=""></a>
                                                            </td>
                                                            <script>
                                            ...
                                            <table class="table">
                                                ...
                                                ?>
                                                        ...
                                                        <tr class="ni_bf_nonveg" id="ni_bf_nonveg<?= $id ?>">
                                                            ...
                                                            <td class="text-center">
                                                                <a href="javascript:void(0)" class="add-menu-row addbtn_ni_bf_nonveg" onclick="additem('ni_bf_nonveg')" style="<?php if ($id != $nonvegbflength) {
                                                                                                                                                                                    echo 'display:none;';
                                                                                                                                                                                } ?>""><img src=" <?= FRONT_URL ?>assets/images/menu-plus.svg" alt=""></a>
                                                                <a href="javascript:void(0)" class="rmbtn_ni_bf_nonveg" onclick="removeitem('ni_bf_nonveg<?= $id ?>')" style="<?php if ($id == $nonvegbflength) {
                                                                                                                                                                                    echo 'display:none;';
                                                                                                                                                                                } ?>"><img src="<?= FRONT_URL ?>assets/images/trash.svg" alt=""></a>
                                                            </td>
                                                            <script>
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <tr class="ni_lunch_<?= $cat ?>" id="ni_lunch_<?= $cat . $id ?>">
                                                                        ...
                                                                        <td class="text-center">
                                                                            <a href="javascript:void(0)" class="add-menu-row addbtn_ni_lunch_<?= $cat ?>" onclick="additem('ni_lunch_<?= $cat ?>','lunch_dinner')" style="<?php if ($id != $lunchlength) {
                                                                                                                                                                                                                                echo 'display:none;';
                                                                                                                                                                                                                            } ?>""><img src=" <?= FRONT_URL ?>assets/images/menu-plus.svg" alt=""></a>
                                                                            <a href="javascript:void(0)" class="rmbtn_ni_lunch_<?= $cat ?>" onclick="removeitem('ni_lunch_<?= $cat . $id ?>')" style="<?php if ($id == $lunchlength) {
                                                                                                                                                                                                            echo 'display:none;';
                                                                                                                                                                                                        } ?>"><img src="<?= FRONT_URL ?>assets/images/trash.svg" alt=""></a>
                                                                        </td>
                                                                        <script>
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            ?>
                                                                ...
                                                                <tr class="ni_dinner_<?= $cat ?>" id="ni_dinner_<?= $cat . $id ?>">
                                                                    ...
                                                                    <td class="text-center">
                                                                        <a href="javascript:void(0)" class="add-menu-row addbtn_ni_dinner_<?= $cat ?>" onclick="additem('ni_dinner_<?= $cat ?>')" style="<?php if ($id != $dinnerlength) {
                                                                                                                                                                                                            echo 'display:none;';
                                                                                                                                                                                                        } ?>""><img src=" <?= FRONT_URL ?>assets/images/menu-plus.svg" alt=""></a>
                                                                        <a href="javascript:void(0)" class="rmbtn_ni_dinner_<?= $cat ?>" onclick="removeitem('ni_dinner_<?= $cat . $id ?>')" style="<?php if ($id == $dinnerlength) {
                                                                                                                                                                                                    echo 'display:none;';
                                                                                                                                                                                                } ?>"><img src="<?= FRONT_URL ?>assets/images/trash.svg" alt=""></a>
                                                                    </td>
                                                                    <script>
                                            ...
                                            <table class="table">
                                                ...
                                                ?>
                                                        ...
                                                        <tr class="oi_bf_veg" id="oi_bf_veg<?= $id ?>">
                                                            ...
                                                            <td class="text-center">
                                                                <a href="javascript:void(0)" class="add-menu-row addbtn_oi_bf_veg" onclick="additem('oi_bf_veg')" style="<?php if ($id != $vegbflength) {
                                                                                                                                                                                echo 'display:none;';
                                                                                                                                                                            } ?>""><img src=" <?= FRONT_URL ?>assets/images/menu-plus.svg" alt=""></a>
                                                                <a href="javascript:void(0)" class="rmbtn_oi_bf_veg" onclick="removeitem('oi_bf_veg<?= $id ?>')" style="<?php if ($id == $vegbflength) {
                                                                                                                                                                            echo 'display:none;';
                                                                                                                                                                        } ?>"><img src="<?= FRONT_URL ?>assets/images/trash.svg" alt=""></a>
                                                            </td>
                                                            <script>
                                            ...
                                            <table class="table">
                                                ...
                                                ?>
                                                        ...
                                                        <tr class="oi_bf_nonveg" id="oi_bf_nonveg<?= $id ?>">
                                                            ...
                                                            <td class="text-center">
                                                                <a href="javascript:void(0)" class="add-menu-row addbtn_oi_bf_nonveg" onclick="additem('oi_bf_nonveg')" style="<?php if ($id != $nonvegbflength) {
                                                                                                                                                                                    echo 'display:none;';
                                                                                                                                                                                } ?>""><img src=" <?= FRONT_URL ?>assets/images/menu-plus.svg" alt=""></a>
                                                                <a href="javascript:void(0)" class="rmbtn_oi_bf_nonveg" onclick="removeitem('oi_bf_nonveg<?= $id ?>')" style="<?php if ($id == $nonvegbflength) {
                                                                                                                                                                                    echo 'display:none;';
                                                                                                                                                                                } ?>"><img src="<?= FRONT_URL ?>assets/images/trash.svg" alt=""></a>
                                                            </td>
                                                            <script>
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <tr class="oi_lunch_<?= $cat ?>" id="oi_lunch_<?= $cat . $id ?>">
                                                                        ...
                                                                        <td class="text-center">
                                                                            <a href="javascript:void(0)" class="add-menu-row addbtn_oi_lunch_<?= $cat ?>" onclick="additem('oi_lunch_<?= $cat ?>','lunch_dinner')" style="<?php if ($id != $lunchlength) {
                                                                                                                                                                                                                                echo 'display:none;';
                                                                                                                                                                                                                            } ?>""><img src=" <?= FRONT_URL ?>assets/images/menu-plus.svg" alt=""></a>
                                                                            <a href="javascript:void(0)" class="rmbtn_oi_lunch_<?= $cat ?>" onclick="removeitem('oi_lunch_<?= $cat . $id ?>')" style="<?php if ($id == $lunchlength) {
                                                                                                                                                                                                            echo 'display:none;';
                                                                                                                                                                                                        } ?>"><img src="<?= FRONT_URL ?>assets/images/trash.svg" alt=""></a>
                                                                        </td>
                                                                        <script>
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            ?>
                                                                ...
                                                                <tr class="oi_dinner_<?= $cat ?>" id="oi_dinner_<?= $cat . $id ?>">
                                                                    ...
                                                                    <td class="text-center">
                                                                        <a href="javascript:void(0)" class="add-menu-row addbtn_oi_dinner_<?= $cat ?>" onclick="additem('oi_dinner_<?= $cat ?>')" style="<?php if ($id != $dinnerlength) {
                                                                                                                                                                                                            echo 'display:none;';
                                                                                                                                                                                                        } ?>""><img src=" <?= FRONT_URL ?>assets/images/menu-plus.svg" alt=""></a>
                                                                        <a href="javascript:void(0)" class="rmbtn_oi_dinner_<?= $cat ?>" onclick="removeitem('oi_dinner_<?= $cat . $id ?>')" style="<?php if ($id == $dinnerlength) {
                                                                                                                                                                                                    echo 'display:none;';
                                                                                                                                                                                                } ?>"><img src="<?= FRONT_URL ?>assets/images/trash.svg" alt=""></a>
                                                                    </td>
                                                                    <script>
...
<script>
    /* $("[data-provide='itemname_sivegbf1']").each(function () {
   var $element = $(this);
    ...
    function checkfile(obj, element) {
        ...
        switch (val.substring(val.lastIndexOf('.') + 1).toLowerCase()) {
            ...
            default:
                ...
                $('#img_' + element + id).attr('src', SITE_URL + "assets/images/upload-icon.svg");
                notifyme.create({
                    title: "Image",
                    text: "Accept only image file !",
                    type: "alert"
                });
                break;
        }
