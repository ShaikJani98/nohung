<?php
$headerData = $this->foodies_headerlib->data();
  ...
  <body onload="submitPayuForm()">
    ...
    <form action="<?php echo $action; ?>" method="post" name="payuForm" style="display: none;">
      ...
      <table>
        ...
        <tr>
          <td>Amount: </td>
          <td><input name="amount" value="<?php if(!empty($posted['amount'])) { echo $posted['amount']; } ?>" /></td>
          <td>First Name: </td>
        ...
        <tr>
          <!-- <td>bankcode: </td>
          <td><input name="enforce_paymethod" value="<?php if(!empty($posted['bankcode'])) { echo $posted['bankcode']; } ?>" /></td> -->
          <td>PG: </td>
          <td><input name="pg" value="<?php echo (empty($posted['pg'])) ? '' : $posted['pg']; ?>" /></td>
        </tr>
        <tr>
