                  ...
                  <tbody>
                    <?php
                      ...
                      <tr id="tr<?=$row['id']; ?>">
                        ...
                        <td>
                          <a class="<?=view_class;?>" href="<?=ADMIN_URL?>offer/view-offer/<?=$row['id']; ?>" title="<?=view_title?>"><?=view_text;?></a>
                          <a class="<?=edit_class;?>" href="<?=ADMIN_URL?>offer/edit-offer/<?=$row['id']; ?>" title="<?=edit_title?>"><?=edit_text;?></a>
                          <a href="#" onclick="deleterow(<?=$row['id']; ?>,'<?php echo base_url(); ?><?php echo ADMINFOLDER; ?>offer/delete-offer')"  class="<?=delete_class?>" title="<?=delete_title?>"><?=stripslashes(delete_text);?></a>
                        </td>
                      </tr>
                      <?php $srno++; } ?>
                  </tbody>
