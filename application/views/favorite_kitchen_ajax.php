<?php if(!empty($favorite_kitchen)){
    foreach($favorite_kitchen as $favorite_kitchen){ ?>
        
        <?php if($favorite_kitchen['id'] == "kitchenid"){
            
            foreach($favorite_kitchen['kitchenid'] as $customerid){ ?>
                        ...
                        <div class="left-part">
                            <div class="order-history-menu">
                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    <li class="main-heading"><?=$customerid['item_name']?></li>
