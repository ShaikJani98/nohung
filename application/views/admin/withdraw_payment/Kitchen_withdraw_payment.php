<div class="page-content">
    <div class="page-heading">    
        <h1>Kitchen Withdraw Payment</h1>    
        <small>
          <ol class="breadcrumb">                        
            <li><a href="<?=base_url(); ?><?=ADMINFOLDER; ?>dashboard">Dashboard</a></li>
            <li class="active">Kitchen Withdraw Payment</li>
          </ol>
        </small>                
    </div>
                  ...
                  <tbody>
                    <?php
                      ...
                      <tr id="tr<?=$row['id']; ?>">
                        ...
                        <td><?=$srno; ?></td>
                        <td><a href="<?=ADMIN_URL?>user/view-user/<?=$row['kitchen_id']?>" target="_blank" title="View Kitchen"><?=$row['kitchenname'];?></a></td>
                        <td><?=$row['email'];?></td>
...
<script>
    ...
    function changestatus(status, id){
        var uurl = SITE_URL+"kitchen-withdraw-payment/update-status";
        if(id!=''){
            swal({    
