    ...
    <div class="page-heading">            
        ...
        <small>
            <ol class="breadcrumb">                        
              ...
              <li><a href="<?php echo ADMIN_URL; ?>offer">Offer Management</a></li>
						...
						<div class="col-md-12 p-n">
							<div class="col-md-6">
								<div class="form-group row" id="title_div">
									...
									<div class="col-md-9">
										<input id="title" class="form-control" name="title" value="<?php if(isset($offerdata)){ echo $offerdata['title']; } ?>" type="text" tabindex="1">
									</div>
								</div>
							</div>
							<div class="col-md-6">
