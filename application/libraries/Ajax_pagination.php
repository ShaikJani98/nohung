...
class Ajax_pagination{
    ...
    var $first_link      = '<i class="fa fa-angle-left" aria-hidden="true"></i><i class="fa fa-angle-left" aria-hidden="true"></i>';
    var $next_link       = 'Next <i class="fa fa-angle-right" aria-hidden="true"></i>';
    var $prev_link       = '<i class="fa fa-angle-left" aria-hidden="true"></i> Prev';
    var $last_link       = '<i class="fa fa-angle-right" aria-hidden="true"></i><i class="fa fa-angle-right" aria-hidden="true"></i>';
    var $uri_segment     = 3;
    ...
    var $cur_tag_open    = '<li class="page-item active"><a href="javascript:void(0)" class="page-link">';
    ...
    function create_links(){
        ...
        function loadData(page){  
            ...
            $.ajax({
                ...
                data: { page: page,filterarray:JSON.stringify(<?=$this->filterarray?>)},
