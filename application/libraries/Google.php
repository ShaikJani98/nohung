...
class Google{
    ...
    public function __construct(){
        ...
        $this->client->setApplicationName($CI->config->item('application_name', SITE_NAME));
        $this->client->setClientId($CI->config->item('client_id', GOOGLE_CLIENT_ID));
        $this->client->setClientSecret($CI->config->item('client_secret', GOOGLE_CLIENT_SECRET));
        $this->client->setRedirectUri($CI->config->item('redirect_uri', FRONT_URL));
        $this->client->setDeveloperKey($CI->config->item('api_key', GOOGLE_API_KEY));
