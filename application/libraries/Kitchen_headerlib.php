...
//public $user_agent;
	...
	public function __construct() {
		...
		$this->css_path = KITCHEN_CSS_URL; // Set default path to browser specific css files relative to FRONT_URL.
		$this->plugin_path = KITCHEN_PLUGIN_URL; // Set default path to browser specific css files relative to FRONT_URL.
		$this->javascript_path = KITCHEN_JS_URL; // Set path to javascripts
