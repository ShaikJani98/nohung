...
class User extends Admin_Controller {
	...
	public function update_status(){
		...
		if($userdata['userstatus'] == "1"){
			...
			/* SEND EMAIL TO USER */
			$MessageArr = array("{logo}" => '<a href="'.DOMAIN_URL.'"><img src="'.SETTING_PATH.SITE_LOGO.'" style="width:auto;height:60px;"></a>',
			...
			//Send mail with email format store in database
			$this->User->sendMail($emailtype, $userdata['email'], $MessageArr);
		}
        echo 1;
	}
}