$(document).ready(function() {
  ...
  function checkvalidation(){
    ...
    if (starttime == '') {
      $("#starttime_div").addClass("has-error is-focused");
      new PNotify({ title: 'Please select start time !', styling: 'fontawesome', delay: '3000', type: 'error' });
      isvalid = 0;
    } else {
      $("#starttime_div").removeClass("has-error is-focused");
    }
    if (endtime == '') {
      $("#endtime_div").addClass("has-error is-focused");
      new PNotify({ title: 'Please select end time !', styling: 'fontawesome', delay: '3000', type: 'error' });
      isvalid = 0;
    } else {
      $("#endtime_div").removeClass("has-error is-focused");
    }
    if(discount == 0){
